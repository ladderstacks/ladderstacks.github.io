...
function foliox_tm_modalbox_news(){
	...
	button.on('click',function(){
		...
		modalBox.find('.news_popup_informations').prepend('<div class="image"><img src="img/thumbs/4-2.webp" alt="" /><div class="main" data-img-url="'+image+'"></div></div>');
...
function foliox_tm_modalbox_portfolio(){
	...
	button.off().on('click',function(){
		...
		modalBox.addClass('opened');
		modalBox.find('.description_wrap').html(content);
		modalBox.find('.popup_details').prepend('<div class="top_image"><img src="img/thumbs/4-2.webp" alt="" /><div class="main" data-img-url="'+image+'"></div></div>');
